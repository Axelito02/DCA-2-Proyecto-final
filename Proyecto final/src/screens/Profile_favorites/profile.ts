...
export default class ProfilesFavorites extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const appProfile = this.ownerDocument.createElement("comp-profilefavorites");
...
customElements.define('compscreen-favorites', ProfilesFavorites);
