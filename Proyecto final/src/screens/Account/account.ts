...
export default class Accounts extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const appProfile_account = this.ownerDocument.createElement("comp-account");
        ...
        main.appendChild(appProfile_account)
...
customElements.define('comp-accounts', Accounts);
