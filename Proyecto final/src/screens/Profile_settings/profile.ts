...
export default class ProfilesSettings extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const appProfile = this.ownerDocument.createElement("comp-profilesetting");
...
customElements.define('compscreen-profilesettings', ProfilesSettings);
