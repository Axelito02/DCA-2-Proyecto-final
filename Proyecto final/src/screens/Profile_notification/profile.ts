...
export default class Profilesnotification extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const appProfile = this.ownerDocument.createElement("comp-profilenotification");
...
customElements.define('compscreen-notification', Profilesnotification);
