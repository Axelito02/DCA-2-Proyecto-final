...
export default class ProfilesFriends extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const appProfile = this.ownerDocument.createElement("comp-profilefriends");
...
customElements.define('compscreen-profilefriends', ProfilesFriends);
