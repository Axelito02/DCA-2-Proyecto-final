...
export default class ProfileFavorites extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const AppContent = this.ownerDocument.createElement("content-favorites");
...
customElements.define('comp-profilefavorites', ProfileFavorites);
