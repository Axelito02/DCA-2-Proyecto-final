...
export default class ProfileNotification extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const AppContent = this.ownerDocument.createElement("content-notification");
...
customElements.define('comp-profilenotification', ProfileNotification);
