...
export default class ProfileFriends extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        const AppContent = this.ownerDocument.createElement("content-friends");
...
customElements.define('comp-profilefriends', ProfileFriends);
